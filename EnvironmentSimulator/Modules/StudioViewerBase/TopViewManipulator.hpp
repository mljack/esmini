...
struct ViewSetting
{
    double camera_pos_x_;
    double camera_pos_y_;
    double camera_pos_z_;
    double camera_target_pos_x_;
    double camera_target_pos_y_;
    double camera_target_pos_z_;
...
namespace osgGA
{
    ...
    public:
        ...
        bool moveCameraTo(double x, double y);
        ...
        void setBound(const osg::BoundingSphere& bounding_sphere);

        void setViewportSize(double width, double height);

        void setViewportCenterPixelOffset(double pix_x, double pix_y);

        void MoveMouse(GUIActionAdapter& aa, double x, double y);
    ...
    protected:
        ...
        std::vector<ViewSetting> view_settings_;

        osg::BoundingSphere bounding_sphere_;
        ...
        double viewport_offset_x_ = 0.0;
        double viewport_offset_y_ = 0.0;
